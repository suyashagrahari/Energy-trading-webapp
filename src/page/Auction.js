  ...
  <div className="shadow overflow-hidden  rounded-2xl border-b border-gray-200">
    <table className="min-w-full bg-white">
      <thead className="bg-gray-800 text-white">
        <tr>
          <th className="w-1/5 text-left py-3 px-4 uppercase font-semibold text-sm">Wallet Address</th>
          <th className=" w-1/5 text-left py-3 px-4 uppercase font-semibold text-sm">Pincode</th>
          <th className="w-1/5 text-left py-3 px-4 uppercase font-semibold text-sm">Unit (kwh) </th>
          <th className=" w-1/5 text-left py-3 px-4 uppercase font-semibold text-sm">Buy</th>
        </tr>
      </thead>
