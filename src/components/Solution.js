...
const Solution = () => {
  ...
  >
    ...
    <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-2">
      <a
        class="block rounded-xl flex flex-col text-center p-8 shadow-2xl transition hover:border-yellow-800/20 hover:shadow-yellow-400/20"
        href="/services/digital-campaigns">
       <img src={Image2} className='w-[80%] h-[18rem] ml-auto mr-auto' alt="" />

        <h2 class="mt-4 text-3xl font-bold text-white">Digital campaigns</h2>
